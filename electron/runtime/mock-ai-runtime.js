...
const port = Number(parseArg('--port', process.env.KIVORA_AI_PORT || process.env.STUDYPILOT_AI_PORT || 48612));
const model = parseArg('--model', process.env.KIVORA_AI_MODEL || process.env.STUDYPILOT_AI_MODEL || 'unknown');
