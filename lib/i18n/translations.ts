...
export const GLOBAL_TRANSLATIONS: Record<string, Partial<Record<SupportedLocale, string>>> = {
  ...
  'Study Hub':      { ar: 'مركز الدراسة',  fr: 'Centre d’étude',     es: 'Centro de estudio',   de: 'Lernzentrale',   zh: '学习中心' },
  'Revision Coach': { ar: 'مدرب المراجعة', fr: 'Coach de révision',  es: 'Coach de repaso',     de: 'Lerncoach',      zh: '复习教练' },
