...
export function AudioPodcast() {
  const { t } = useI18n({
    ...
    'Select from Kivora': 'اختر من Kivora',
    ...
    'Paste your study material here, or select a file from Kivora above...': 'ألصق المادة الدراسية هنا، أو اختر ملفًا من Kivora بالأعلى...',
    ...
    <div className="audio-podcast">
      ...
      <div className="file-selector-section">
        <button
          ...
          disabled={isPlaying}
        >
          📁 {showFileSelector ? t('Hide File Selector') : t('Select from Kivora')}
        </button>
      ...
      <div className="input-section">
        ...
        <textarea
          ...
          placeholder={t('Paste your study material here, or select a file from Kivora above...')}
          rows={8}
          disabled={isPlaying}
        />
        {text && (
