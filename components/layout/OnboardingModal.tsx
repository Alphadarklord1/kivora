...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'Review your flashcard decks using FSRS-4.5 spaced repetition — the same algorithm used by Anki. Cards you struggle with come back sooner; easy cards get spread out.',
    highlight: 'Workspace → Flashcard tool → grade each card',
    tip: 'Grade buttons show the exact next-review interval so you know what to expect before you tap.',
    actionLabel: 'Open workspace',
    href: '/workspace',
  },
  {
    icon: '📚',
    title: 'Library — all your generated content',
    desc: 'Every summary, quiz, and set of notes you generate is saved to your Library. Filter by folder, search by keyword, and export or print anything in one click.',
    highlight: 'Library tab → filter by type → Print / Export',
    tip: 'You can share any Library item with a classmate using a single link — no account required to view.',
  ...
  },
  {
    ...
    tip: "Click any day on the calendar to see that day's tasks. Completed sessions are tracked in Analytics.",
  ...
  },
  {
    ...
    desc: 'See how many items you\'ve generated, your study streaks, flashcard recall rates, and time spent across folders. Spot weak areas before exam day.',
    highlight: 'Analytics in the sidebar',
    tip: 'Keep your streak alive — a daily reminder fires if you haven\'t studied by evening.',
  ...
  },
  {
    ...
    desc: 'From algebra and calculus to matrices and vectors — get full working steps, LaTeX output, and interactive graphs. Type any expression and Kivora shows every step.',
    highlight: 'Math Solver in the sidebar → type expression → Solve',
    tip: 'The solver uses a fast symbolic engine first, then falls back to AI for trickier problems.',
