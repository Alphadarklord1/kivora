    ...
    >
      ...
      >
        ...
        <h1 style={{ marginTop: '0.75rem', marginBottom: '0.75rem', fontSize: '2rem', lineHeight: 1.2 }}>
          Kivora runs as a desktop app
        </h1>
        <p style={{ margin: 0, color: '#cbd5e1', lineHeight: 1.65 }}>
          This deployment is desktop-only. Open Kivora in the installed app on macOS or Windows to use workspace, AI tools, and local study data.
        </p>
