...
import styles from '@/app/(dashboard)/decks/[deckId]/page.module.css';
...
export function StudyDeckPage() {
  ...
  useEffect(() => {
    ...
    router.replace(nextQuery ? `/study/${deckId}?${nextQuery}` : `/study/${deckId}`, { scroll: false });
  ...
  if (!deck || missing) {
    return (
      <div className={styles.emptyState}>
        ...
        <button className={styles.primaryButton} onClick={() => router.push('/study')}>
          Back to Study Hub
        </button>
      </div>
    );
  ...
  return (
    <div className={styles.page}>
      <section className={styles.hero}>
        <div>
          <p className={styles.eyebrow}>Study Deck</p>
          {editingMeta ? (
            ...
            <>
              ...
              <p className={styles.description}>
                {deck.description || 'Review what is due, launch the right study mode quickly, and keep the deck edited and ready for quiz generation.'}
              </p>
            </>
          )}
          ...
          <div className={styles.actionGroups}>
            <div className={styles.actionGroup}>
              ...
              <p className={styles.groupHint}>Go straight into review, learn, or test mode from the same deck.</p>
              <div className={styles.actions}>
                <button className={styles.primaryButton} onClick={() => openStudy('review')}>Review due</button>
                ...
                <button className={styles.secondaryButton} onClick={() => openStudy('write')}>Write</button>
              </div>
            </div>
            <div className={styles.actionGroup}>
              <span className={styles.groupLabel}>Tools</span>
              <p className={styles.groupHint}>Turn the same deck into quizzes, summaries, exam prep, and explanations.</p>
              <div className={styles.actions}>
            ...
            <div className={styles.actionGroup}>
              <span className={styles.groupLabel}>Edit & export</span>
              <p className={styles.groupHint}>Keep the deck clean and export it when you need a copy outside Kivora.</p>
              <div className={styles.actions}>
        ...
        <div className={styles.previewCard}>
          <div className={styles.previewHeader}>
            <div>
              <h2>Quick preview</h2>
              <p>Check the first few cards before you study, edit, or generate something new from this deck.</p>
            </div>
      ...
      {output && (
        <section ref={resultRef} className={styles.outputCard}>
          <div className={styles.sectionHeader}>
            <div>
              <h2>{output.title}</h2>
              <p>Saved to Library with Study Hub metadata for later review.</p>
            </div>
      ...
      <section className={styles.editorCard}>
        <div className={styles.sectionHeader}>
          <div>
            <h2>Deck editor</h2>
            <p>Rename the deck, revise the description, and edit cards inline before jumping back into study mode.</p>
          </div>
          <div className={styles.actions}>
      ...
      <section ref={studyRef} className={styles.studyCard}>
        <div className={styles.sectionHeader}>
          <div>
            <h2>Study deck</h2>
            <p>Use the same review, write, test, match, learn, and stats modes as the rest of the FSRS system.</p>
          </div>
