  ...
  return (
    <div className="auth-shell">
      <div className="auth-card">
        ...
        {hasOAuth && <div className="auth-divider">or sign in with email</div>}
        ...
        <Link href="/workspace" className="btn btn-secondary btn-full" style={{ textDecoration: 'none', display: 'flex', marginTop: hasOAuth ? 10 : 0 }}>
          Continue as Guest
        </Link>
