  ...
  const handleOAuthSignIn = async (provider: 'google' | 'github') => {
    ...
    try {
      if (!providers?.[provider]) {
        setError(`${provider === 'google' ? 'Google' : 'GitHub'} sign-up is not configured yet.`);
      ...
      <div className="auth-card">
        ...
        <div className="oauth-buttons">
          <button
            ...
            disabled={oauthLoading !== null || !providers?.google}
          >
          ...
          <button
            ...
            disabled={oauthLoading !== null || !providers?.github}
          >
