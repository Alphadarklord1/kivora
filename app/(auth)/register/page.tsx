      ...
      <div className="auth-card">
        ...
        <div className="oauth-buttons">
          <button
            ...
            disabled={oauthLoading !== null || !providers?.google || Boolean(authCapabilities?.oauthDisabled)}
          >
          ...
          <button
            ...
            disabled={oauthLoading !== null || !providers?.github || Boolean(authCapabilities?.oauthDisabled)}
          >
